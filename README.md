# OGC Web Coverage Service 2.0.1 Range Subsetting Extension Test-Suite

The OGC Web Coverage Service 2.0.1 Range Subsetting Extension Test-Suite provides the Executable Test Script (ETS) to test implementations against the following specification(s):
  ...
  * [WCS RSUB] [OGC Web Coverage Service 2.0 Interface Standard - Range Subsetting Extension](https://portal.opengeospatial.org/files/?artifact_id=5186) (OGC 12-040)
  * Compliance Test Language (CTL) 0.5


Detailed information about this test suite is available [here](http://opengeospatial.github.io/ets-wcs-rsub10/).
...
Issue tracker is available at [github](https://github.com/opengeospatial/ets-wcs-rsub10/issues).
